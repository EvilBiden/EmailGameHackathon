...
public class EmailDefender {
    ...
    private void showTutorial() {
        ...
        // Tutorial text with Windows 95 font and scrolling capability
        ...
        // Add scroll capability to ensure text fits
        JScrollPane scrollPane = new JScrollPane(textArea);
        scrollPane.setBorder(BorderFactory.createEmptyBorder());
        scrollPane.setPreferredSize(new Dimension(300, 200)); // Set a fixed size
        scrollPane.setBackground(Windows95Theme.WINDOW_BG);

        panel.add(iconLabel, BorderLayout.WEST);
        panel.add(scrollPane, BorderLayout.CENTER);

        // Create and configure a custom dialog instead of using JOptionPane
        JDialog tutorialDialog = new JDialog(mainFrame, "Tutorial", true);
        tutorialDialog.setLayout(new BorderLayout());
        tutorialDialog.setBackground(Windows95Theme.WINDOW_BG);

        // Add the content panel
        tutorialDialog.add(panel, BorderLayout.CENTER);

        // Add an OK button at the bottom
        JPanel buttonPanel = new JPanel(new FlowLayout(FlowLayout.CENTER));
        buttonPanel.setBackground(Windows95Theme.WINDOW_BG);
        JButton okButton = Windows95Theme.createButton("OK");
